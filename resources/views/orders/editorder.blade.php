                                ...
                                <div class="card-body  p-5">
                                    ...
                                    <form action="{{route('orders.update',$order)}}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-md-6 mb-2">
                                                <div class="form-outline">
                                                    <input value="{{$order->user_first_name}}" type="text" name="user_first_name" id="user_first_name"
                                                        class="form-control" />
                                            ...
                                            <div class="col-12 col-md-6 mb-2">
                                                <div class="form-outline">
                                                    <input  value="{{$order->user_last_name}}" type="text" name="user_last_name" id="user_last_name"
                                                        class="form-control" />
                                        ...
                                        <div class="form-outline mb-2">
                                            <input value="{{$order->billing_email}}" type="text" name="billing_email" id="billing_email"
                                                class="form-control" />
                                        ...
                                        <!-- Email input -->
                                        <div class="form-outline mb-2">
                                            <input value="{{$order->billing_address}}" type="text" name="billing_address" id="billing_address"
                                                class="form-control" />
                                        ...
                                        <!-- Number input -->
                                        <div class="form-outline mb-2">
                                            <input value="{{$order->phone}}" type="text" name="phone" id="phone" class="form-control" />
