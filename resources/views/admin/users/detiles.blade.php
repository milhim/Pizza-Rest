                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="bg-light rounded-3  mb-2">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item nav-link"><a class="nav-link p-0" href="{{ route('home') }}">Home</a>
                            </li>
                            <li class="breadcrumb-item nav-link" aria-current="page">
                                {{ $user->firstname . ' ' . $user->lastname }} Profile</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <a class="btn mt-2" href="">Orders</a>
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-center  mt-2">
                                        <a class="btn" href="{{route('admin.update.user',$user)}}">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
